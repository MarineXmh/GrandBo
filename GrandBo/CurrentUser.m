...
+ (NSString *)loadCurrentUser {
    NSString *path = [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) objectAtIndex:0]stringByAppendingPathComponent:@"currentUser.txt"];
    NSError *error = nil;
