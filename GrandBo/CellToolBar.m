...
- (instancetype)init {
    ...
    [self.expand setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
    [self.expand setTitleColor:[UIColor blackColor] forState:UIControlStateHighlighted];
    self.expand.titleLabel.textAlignment = NSTextAlignmentLeft;
    self.expand.titleLabel.font = [UIFont systemFontOfSize:10.0];
    [self.expand setImage:[UIImage imageNamed:@"timeline_icon_retweet"] forState:UIControlStateNormal];
    self.expand.opaque = YES;
    ...
    [self.good setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
